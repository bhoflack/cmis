...
/**
 * <p>Java class for ArrayOfHostNumericSensorInfo complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="HostNumericSensorInfo" type="{urn:vim25}HostNumericSensorInfo" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfHostNumericSensorInfo {
     ...
     * This is why there is not a <CODE>set</CODE> method for the hostNumericSensorInfo property.
     * 
     * <p>
    ...
    public List<HostNumericSensorInfo> getHostNumericSensorInfo() {
        if (hostNumericSensorInfo == null) {
            hostNumericSensorInfo = new ArrayList<HostNumericSensorInfo>();
        }
