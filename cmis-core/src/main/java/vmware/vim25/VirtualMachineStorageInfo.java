...
/**
 * <p>Java class for VirtualMachineStorageInfo complex type.
 * 
    ...
    extends DynamicData
{
     ...
     * This is why there is not a <CODE>set</CODE> method for the perDatastoreUsage property.
     * 
     * <p>
    ...
    public List<VirtualMachineUsageOnDatastore> getPerDatastoreUsage() {
        if (perDatastoreUsage == null) {
            perDatastoreUsage = new ArrayList<VirtualMachineUsageOnDatastore>();
        }
