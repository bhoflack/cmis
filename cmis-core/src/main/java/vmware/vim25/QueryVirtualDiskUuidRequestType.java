...
/**
 * <p>Java class for QueryVirtualDiskUuidRequestType complex type.
 * 
...
@XmlType(name = "QueryVirtualDiskUuidRequestType", propOrder = {
    "_this",
    "name",
    "datacenter"
})
public class QueryVirtualDiskUuidRequestType {
