...
/**
 * <p>Java class for AddDVPortgroupRequestType complex type.
 * 
 ...
 *         &lt;element name="spec" type="{urn:vim25}DVPortgroupConfigSpec" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "AddDVPortgroupRequestType", propOrder = {
    "_this",
    "spec"
})
public class AddDVPortgroupRequestType {
    ...
    public List<DVPortgroupConfigSpec> getSpec() {
        if (spec == null) {
            spec = new ArrayList<DVPortgroupConfigSpec>();
        }
        return this.spec;
    }
