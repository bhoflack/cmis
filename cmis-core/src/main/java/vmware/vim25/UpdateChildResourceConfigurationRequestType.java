...
/**
 * <p>Java class for UpdateChildResourceConfigurationRequestType complex type.
 * 
 ...
 *         &lt;element name="spec" type="{urn:vim25}ResourceConfigSpec" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "UpdateChildResourceConfigurationRequestType", propOrder = {
    "_this",
    "spec"
})
public class UpdateChildResourceConfigurationRequestType {
    ...
    public List<ResourceConfigSpec> getSpec() {
        if (spec == null) {
            spec = new ArrayList<ResourceConfigSpec>();
        }
        return this.spec;
    }
