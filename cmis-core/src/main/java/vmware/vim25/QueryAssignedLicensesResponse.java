 ...
 *       &lt;sequence>
 *         &lt;element name="returnval" type="{urn:vim25}LicenseAssignmentManagerLicenseAssignment" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class QueryAssignedLicensesResponse {
    ...
    public List<LicenseAssignmentManagerLicenseAssignment> getReturnval() {
        if (returnval == null) {
            returnval = new ArrayList<LicenseAssignmentManagerLicenseAssignment>();
        }
