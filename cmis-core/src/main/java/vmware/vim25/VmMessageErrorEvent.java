...
/**
 * <p>Java class for VmMessageErrorEvent complex type.
 * 
...
@XmlType(name = "VmMessageErrorEvent", propOrder = {
    "message",
    "messageInfo"
})
public class VmMessageErrorEvent
    extends VmEvent
{
    ...
    public List<VirtualMachineMessage> getMessageInfo() {
        if (messageInfo == null) {
            messageInfo = new ArrayList<VirtualMachineMessage>();
        }
