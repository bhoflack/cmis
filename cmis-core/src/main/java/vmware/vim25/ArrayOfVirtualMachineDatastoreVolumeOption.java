...
/**
 * <p>Java class for ArrayOfVirtualMachineDatastoreVolumeOption complex type.
 * 
...
public class ArrayOfVirtualMachineDatastoreVolumeOption {
     ...
     * This is why there is not a <CODE>set</CODE> method for the virtualMachineDatastoreVolumeOption property.
     * 
     * <p>
    ...
    public List<VirtualMachineDatastoreVolumeOption> getVirtualMachineDatastoreVolumeOption() {
        if (virtualMachineDatastoreVolumeOption == null) {
            virtualMachineDatastoreVolumeOption = new ArrayList<VirtualMachineDatastoreVolumeOption>();
        }
