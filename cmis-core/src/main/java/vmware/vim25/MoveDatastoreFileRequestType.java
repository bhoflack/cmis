...
/**
 * <p>Java class for MoveDatastoreFileRequestType complex type.
 * 
...
@XmlType(name = "MoveDatastoreFileRequestType", propOrder = {
    "_this",
    "sourceName",
    "sourceDatacenter",
    "destinationName",
...
public class MoveDatastoreFileRequestType {
