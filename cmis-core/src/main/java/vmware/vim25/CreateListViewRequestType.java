...
/**
 * <p>Java class for CreateListViewRequestType complex type.
 * 
 ...
 *         &lt;element name="obj" type="{urn:vim25}ManagedObjectReference" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "CreateListViewRequestType", propOrder = {
    "_this",
    "obj"
})
public class CreateListViewRequestType {
    ...
    public List<ManagedObjectReference> getObj() {
        if (obj == null) {
            obj = new ArrayList<ManagedObjectReference>();
        }
        return this.obj;
    }
