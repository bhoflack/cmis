...
/**
 * <p>Java class for ArrayOfNetIpConfigSpecIpAddressSpec complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="NetIpConfigSpecIpAddressSpec" type="{urn:vim25}NetIpConfigSpecIpAddressSpec" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfNetIpConfigSpecIpAddressSpec {
     ...
     * This is why there is not a <CODE>set</CODE> method for the netIpConfigSpecIpAddressSpec property.
     * 
     * <p>
    ...
    public List<NetIpConfigSpecIpAddressSpec> getNetIpConfigSpecIpAddressSpec() {
        if (netIpConfigSpecIpAddressSpec == null) {
            netIpConfigSpecIpAddressSpec = new ArrayList<NetIpConfigSpecIpAddressSpec>();
        }
