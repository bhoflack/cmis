...
/**
 * <p>Java class for CannotChangeHaSettingsForFtSecondary complex type.
 * 
...
@XmlType(name = "CannotChangeHaSettingsForFtSecondary", propOrder = {
    "vm",
    "vmName"
})
public class CannotChangeHaSettingsForFtSecondary
