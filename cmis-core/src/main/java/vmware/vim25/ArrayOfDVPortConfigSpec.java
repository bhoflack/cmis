...
/**
 * <p>Java class for ArrayOfDVPortConfigSpec complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="DVPortConfigSpec" type="{urn:vim25}DVPortConfigSpec" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfDVPortConfigSpec {
     ...
     * This is why there is not a <CODE>set</CODE> method for the dvPortConfigSpec property.
     * 
     * <p>
    ...
    public List<DVPortConfigSpec> getDVPortConfigSpec() {
        if (dvPortConfigSpec == null) {
            dvPortConfigSpec = new ArrayList<DVPortConfigSpec>();
        }
