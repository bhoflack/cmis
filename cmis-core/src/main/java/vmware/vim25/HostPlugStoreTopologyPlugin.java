...
/**
 * <p>Java class for HostPlugStoreTopologyPlugin complex type.
 * 
...
@XmlType(name = "HostPlugStoreTopologyPlugin", propOrder = {
    "key",
    "name",
    "device",
    "claimedPath"
    ...
    extends DynamicData
{
    ...
    /**
     * Gets the value of the claimedPath property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the claimedPath property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
    ...
    public List<String> getClaimedPath() {
        if (claimedPath == null) {
            claimedPath = new ArrayList<String>();
        }
