...
/**
 * <p>Java class for ArrayOfIpPoolAssociation complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="IpPoolAssociation" type="{urn:vim25}IpPoolAssociation" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfIpPoolAssociation {
     ...
     * This is why there is not a <CODE>set</CODE> method for the ipPoolAssociation property.
     * 
     * <p>
    ...
    public List<IpPoolAssociation> getIpPoolAssociation() {
        if (ipPoolAssociation == null) {
            ipPoolAssociation = new ArrayList<IpPoolAssociation>();
        }
