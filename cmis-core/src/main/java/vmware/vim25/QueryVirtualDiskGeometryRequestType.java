...
/**
 * <p>Java class for QueryVirtualDiskGeometryRequestType complex type.
 * 
...
@XmlType(name = "QueryVirtualDiskGeometryRequestType", propOrder = {
    "_this",
    "name",
    "datacenter"
})
public class QueryVirtualDiskGeometryRequestType {
