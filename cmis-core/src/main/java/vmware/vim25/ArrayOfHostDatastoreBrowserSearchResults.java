...
/**
 * <p>Java class for ArrayOfHostDatastoreBrowserSearchResults complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="HostDatastoreBrowserSearchResults" type="{urn:vim25}HostDatastoreBrowserSearchResults" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfHostDatastoreBrowserSearchResults {
     ...
     * This is why there is not a <CODE>set</CODE> method for the hostDatastoreBrowserSearchResults property.
     * 
     * <p>
    ...
    public List<HostDatastoreBrowserSearchResults> getHostDatastoreBrowserSearchResults() {
        if (hostDatastoreBrowserSearchResults == null) {
            hostDatastoreBrowserSearchResults = new ArrayList<HostDatastoreBrowserSearchResults>();
        }
