 ...
 *       &lt;sequence>
 *         &lt;element name="returnval" type="{urn:vim25}HostUnresolvedVmfsResolutionResult" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ResolveMultipleUnresolvedVmfsVolumesResponse {
    ...
    public List<HostUnresolvedVmfsResolutionResult> getReturnval() {
        if (returnval == null) {
            returnval = new ArrayList<HostUnresolvedVmfsResolutionResult>();
        }
