...
/**
 * <p>Java class for EagerZeroVirtualDiskRequestType complex type.
 * 
...
@XmlType(name = "EagerZeroVirtualDiskRequestType", propOrder = {
    "_this",
    "name",
    "datacenter"
})
public class EagerZeroVirtualDiskRequestType {
