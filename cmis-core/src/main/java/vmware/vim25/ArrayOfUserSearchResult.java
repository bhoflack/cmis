...
/**
 * <p>Java class for ArrayOfUserSearchResult complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="UserSearchResult" type="{urn:vim25}UserSearchResult" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfUserSearchResult {
     ...
     * This is why there is not a <CODE>set</CODE> method for the userSearchResult property.
     * 
     * <p>
    ...
    public List<UserSearchResult> getUserSearchResult() {
        if (userSearchResult == null) {
            userSearchResult = new ArrayList<UserSearchResult>();
        }
