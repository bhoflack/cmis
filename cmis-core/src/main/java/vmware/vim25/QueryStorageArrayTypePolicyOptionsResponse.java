 ...
 *       &lt;sequence>
 *         &lt;element name="returnval" type="{urn:vim25}HostStorageArrayTypePolicyOption" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class QueryStorageArrayTypePolicyOptionsResponse {
    ...
    public List<HostStorageArrayTypePolicyOption> getReturnval() {
        if (returnval == null) {
            returnval = new ArrayList<HostStorageArrayTypePolicyOption>();
        }
