...
/**
 * <p>Java class for EnableMultipathPathRequestType complex type.
 * 
...
@XmlType(name = "EnableMultipathPathRequestType", propOrder = {
    "_this",
    "pathName"
})
public class EnableMultipathPathRequestType {
