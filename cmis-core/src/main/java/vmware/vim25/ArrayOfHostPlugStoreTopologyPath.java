...
/**
 * <p>Java class for ArrayOfHostPlugStoreTopologyPath complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="HostPlugStoreTopologyPath" type="{urn:vim25}HostPlugStoreTopologyPath" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfHostPlugStoreTopologyPath {
     ...
     * This is why there is not a <CODE>set</CODE> method for the hostPlugStoreTopologyPath property.
     * 
     * <p>
    ...
    public List<HostPlugStoreTopologyPath> getHostPlugStoreTopologyPath() {
        if (hostPlugStoreTopologyPath == null) {
            hostPlugStoreTopologyPath = new ArrayList<HostPlugStoreTopologyPath>();
        }
