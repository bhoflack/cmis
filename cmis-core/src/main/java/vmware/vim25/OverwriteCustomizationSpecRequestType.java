...
/**
 * <p>Java class for OverwriteCustomizationSpecRequestType complex type.
 * 
...
@XmlType(name = "OverwriteCustomizationSpecRequestType", propOrder = {
    "_this",
    "item"
})
public class OverwriteCustomizationSpecRequestType {
