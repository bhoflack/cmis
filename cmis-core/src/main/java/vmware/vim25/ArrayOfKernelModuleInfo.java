...
/**
 * <p>Java class for ArrayOfKernelModuleInfo complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="KernelModuleInfo" type="{urn:vim25}KernelModuleInfo" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfKernelModuleInfo {
     ...
     * This is why there is not a <CODE>set</CODE> method for the kernelModuleInfo property.
     * 
     * <p>
    ...
    public List<KernelModuleInfo> getKernelModuleInfo() {
        if (kernelModuleInfo == null) {
            kernelModuleInfo = new ArrayList<KernelModuleInfo>();
        }
