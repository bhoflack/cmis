...
/**
 * <p>Java class for UnregisterExtensionRequestType complex type.
 * 
...
@XmlType(name = "UnregisterExtensionRequestType", propOrder = {
    "_this",
    "extensionKey"
})
public class UnregisterExtensionRequestType {
