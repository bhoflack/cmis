 ...
 *       &lt;sequence>
 *         &lt;element name="returnval" type="{urn:vim25}DistributedVirtualSwitchProductSpec" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class QueryAvailableDvsSpecResponse {
    ...
    public List<DistributedVirtualSwitchProductSpec> getReturnval() {
        if (returnval == null) {
            returnval = new ArrayList<DistributedVirtualSwitchProductSpec>();
        }
