...
/**
 * <p>Java class for ZeroFillVirtualDiskRequestType complex type.
 * 
...
@XmlType(name = "ZeroFillVirtualDiskRequestType", propOrder = {
    "_this",
    "name",
    "datacenter"
})
public class ZeroFillVirtualDiskRequestType {
