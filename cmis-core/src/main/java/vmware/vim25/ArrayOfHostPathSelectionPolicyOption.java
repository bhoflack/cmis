...
/**
 * <p>Java class for ArrayOfHostPathSelectionPolicyOption complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="HostPathSelectionPolicyOption" type="{urn:vim25}HostPathSelectionPolicyOption" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfHostPathSelectionPolicyOption {
     ...
     * This is why there is not a <CODE>set</CODE> method for the hostPathSelectionPolicyOption property.
     * 
     * <p>
    ...
    public List<HostPathSelectionPolicyOption> getHostPathSelectionPolicyOption() {
        if (hostPathSelectionPolicyOption == null) {
            hostPathSelectionPolicyOption = new ArrayList<HostPathSelectionPolicyOption>();
        }
