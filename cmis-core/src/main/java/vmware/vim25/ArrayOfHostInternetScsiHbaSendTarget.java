...
/**
 * <p>Java class for ArrayOfHostInternetScsiHbaSendTarget complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="HostInternetScsiHbaSendTarget" type="{urn:vim25}HostInternetScsiHbaSendTarget" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfHostInternetScsiHbaSendTarget {
     ...
     * This is why there is not a <CODE>set</CODE> method for the hostInternetScsiHbaSendTarget property.
     * 
     * <p>
    ...
    public List<HostInternetScsiHbaSendTarget> getHostInternetScsiHbaSendTarget() {
        if (hostInternetScsiHbaSendTarget == null) {
            hostInternetScsiHbaSendTarget = new ArrayList<HostInternetScsiHbaSendTarget>();
        }
