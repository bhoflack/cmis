...
/**
 * <p>Java class for ArrayOfVAppCloneSpecNetworkMappingPair complex type.
 * 
...
@XmlType(name = "ArrayOfVAppCloneSpecNetworkMappingPair", propOrder = {
...
public class ArrayOfVAppCloneSpecNetworkMappingPair {
     ...
     * This is why there is not a <CODE>set</CODE> method for the vAppCloneSpecNetworkMappingPair property.
     * 
     * <p>
    ...
    public List<VAppCloneSpecNetworkMappingPair> getVAppCloneSpecNetworkMappingPair() {
        if (vAppCloneSpecNetworkMappingPair == null) {
            vAppCloneSpecNetworkMappingPair = new ArrayList<VAppCloneSpecNetworkMappingPair>();
        }
