...
/**
 * <p>Java class for NoHostSuitableForFtSecondary complex type.
 * 
...
@XmlType(name = "NoHostSuitableForFtSecondary", propOrder = {
    "vm",
    "vmName"
})
public class NoHostSuitableForFtSecondary
