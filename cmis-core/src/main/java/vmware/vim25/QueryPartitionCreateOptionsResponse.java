 ...
 *       &lt;sequence>
 *         &lt;element name="returnval" type="{urn:vim25}HostDiagnosticPartitionCreateOption" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class QueryPartitionCreateOptionsResponse {
    ...
    public List<HostDiagnosticPartitionCreateOption> getReturnval() {
        if (returnval == null) {
            returnval = new ArrayList<HostDiagnosticPartitionCreateOption>();
        }
