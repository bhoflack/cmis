...
/**
 * <p>Java class for MethodAction complex type.
 * 
 ...
 *         &lt;element name="argument" type="{urn:vim25}MethodActionArgument" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Action
{
    ...
    public List<MethodActionArgument> getArgument() {
        if (argument == null) {
            argument = new ArrayList<MethodActionArgument>();
        }
