...
/**
 * <p>Java class for DefragmentVirtualDiskRequestType complex type.
 * 
...
@XmlType(name = "DefragmentVirtualDiskRequestType", propOrder = {
    "_this",
    "name",
    "datacenter"
})
public class DefragmentVirtualDiskRequestType {
