...
/**
 * <p>Java class for ExpandVmfsDatastoreRequestType complex type.
 * 
 ...
 *         &lt;element name="spec" type="{urn:vim25}VmfsDatastoreExpandSpec"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ExpandVmfsDatastoreRequestType", propOrder = {
    "_this",
    "datastore",
    "spec"
})
public class ExpandVmfsDatastoreRequestType {
     ...
     *     
     */
    public void setSpec(VmfsDatastoreExpandSpec value) {
        this.spec = value;
    }
