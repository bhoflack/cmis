...
/**
 * <p>Java class for ArrayOfVirtualMachinePciPassthroughInfo complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="VirtualMachinePciPassthroughInfo" type="{urn:vim25}VirtualMachinePciPassthroughInfo" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfVirtualMachinePciPassthroughInfo {
     ...
     * This is why there is not a <CODE>set</CODE> method for the virtualMachinePciPassthroughInfo property.
     * 
     * <p>
    ...
    public List<VirtualMachinePciPassthroughInfo> getVirtualMachinePciPassthroughInfo() {
        if (virtualMachinePciPassthroughInfo == null) {
            virtualMachinePciPassthroughInfo = new ArrayList<VirtualMachinePciPassthroughInfo>();
        }
