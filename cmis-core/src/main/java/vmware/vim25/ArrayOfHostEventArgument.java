...
/**
 * <p>Java class for ArrayOfHostEventArgument complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="HostEventArgument" type="{urn:vim25}HostEventArgument" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfHostEventArgument {
     ...
     * This is why there is not a <CODE>set</CODE> method for the hostEventArgument property.
     * 
     * <p>
    ...
    public List<HostEventArgument> getHostEventArgument() {
        if (hostEventArgument == null) {
            hostEventArgument = new ArrayList<HostEventArgument>();
        }
