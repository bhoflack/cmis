...
/**
 * <p>Java class for QueryAvailableDisksForVmfsRequestType complex type.
 * 
...
@XmlType(name = "QueryAvailableDisksForVmfsRequestType", propOrder = {
    "_this",
    "datastore"
})
public class QueryAvailableDisksForVmfsRequestType {
