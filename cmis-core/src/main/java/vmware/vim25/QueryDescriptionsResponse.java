 ...
 *       &lt;sequence>
 *         &lt;element name="returnval" type="{urn:vim25}DiagnosticManagerLogDescriptor" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class QueryDescriptionsResponse {
    ...
    public List<DiagnosticManagerLogDescriptor> getReturnval() {
        if (returnval == null) {
            returnval = new ArrayList<DiagnosticManagerLogDescriptor>();
        }
