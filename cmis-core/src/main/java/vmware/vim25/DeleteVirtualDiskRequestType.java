...
/**
 * <p>Java class for DeleteVirtualDiskRequestType complex type.
 * 
...
@XmlType(name = "DeleteVirtualDiskRequestType", propOrder = {
    "_this",
    "name",
    "datacenter"
})
public class DeleteVirtualDiskRequestType {
