...
/**
 * <p>Java class for DistributedVirtualSwitchManagerHostArrayFilter complex type.
 * 
...
@XmlType(name = "DistributedVirtualSwitchManagerHostArrayFilter", propOrder = {
    "host"
})
public class DistributedVirtualSwitchManagerHostArrayFilter
