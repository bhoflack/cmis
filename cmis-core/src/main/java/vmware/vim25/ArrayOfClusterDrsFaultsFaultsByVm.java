...
/**
 * <p>Java class for ArrayOfClusterDrsFaultsFaultsByVm complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="ClusterDrsFaultsFaultsByVm" type="{urn:vim25}ClusterDrsFaultsFaultsByVm" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfClusterDrsFaultsFaultsByVm {
     ...
     * This is why there is not a <CODE>set</CODE> method for the clusterDrsFaultsFaultsByVm property.
     * 
     * <p>
    ...
    public List<ClusterDrsFaultsFaultsByVm> getClusterDrsFaultsFaultsByVm() {
        if (clusterDrsFaultsFaultsByVm == null) {
            clusterDrsFaultsFaultsByVm = new ArrayList<ClusterDrsFaultsFaultsByVm>();
        }
