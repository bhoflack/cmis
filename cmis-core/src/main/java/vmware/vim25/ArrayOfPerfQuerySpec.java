...
/**
 * <p>Java class for ArrayOfPerfQuerySpec complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="PerfQuerySpec" type="{urn:vim25}PerfQuerySpec" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfPerfQuerySpec {
     ...
     * This is why there is not a <CODE>set</CODE> method for the perfQuerySpec property.
     * 
     * <p>
    ...
    public List<PerfQuerySpec> getPerfQuerySpec() {
        if (perfQuerySpec == null) {
            perfQuerySpec = new ArrayList<PerfQuerySpec>();
        }
