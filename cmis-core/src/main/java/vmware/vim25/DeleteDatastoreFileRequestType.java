...
/**
 * <p>Java class for DeleteDatastoreFileRequestType complex type.
 * 
...
@XmlType(name = "DeleteDatastoreFileRequestType", propOrder = {
    "_this",
    "name",
    "datacenter"
})
public class DeleteDatastoreFileRequestType {
