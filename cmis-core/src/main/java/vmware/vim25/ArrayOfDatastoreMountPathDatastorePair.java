...
/**
 * <p>Java class for ArrayOfDatastoreMountPathDatastorePair complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="DatastoreMountPathDatastorePair" type="{urn:vim25}DatastoreMountPathDatastorePair" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfDatastoreMountPathDatastorePair {
     ...
     * This is why there is not a <CODE>set</CODE> method for the datastoreMountPathDatastorePair property.
     * 
     * <p>
    ...
    public List<DatastoreMountPathDatastorePair> getDatastoreMountPathDatastorePair() {
        if (datastoreMountPathDatastorePair == null) {
            datastoreMountPathDatastorePair = new ArrayList<DatastoreMountPathDatastorePair>();
        }
