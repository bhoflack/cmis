...
/**
 * <p>Java class for VmConfigIncompatibleForFaultTolerance complex type.
 * 
...
@XmlType(name = "VmConfigIncompatibleForFaultTolerance", propOrder = {
    "fault"
})
public class VmConfigIncompatibleForFaultTolerance
