...
/**
 * <p>Java class for ArrayOfVAppOvfSectionSpec complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="VAppOvfSectionSpec" type="{urn:vim25}VAppOvfSectionSpec" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfVAppOvfSectionSpec {
     ...
     * This is why there is not a <CODE>set</CODE> method for the vAppOvfSectionSpec property.
     * 
     * <p>
    ...
    public List<VAppOvfSectionSpec> getVAppOvfSectionSpec() {
        if (vAppOvfSectionSpec == null) {
            vAppOvfSectionSpec = new ArrayList<VAppOvfSectionSpec>();
        }
