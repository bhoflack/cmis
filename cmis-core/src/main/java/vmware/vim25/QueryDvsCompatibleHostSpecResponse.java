 ...
 *       &lt;sequence>
 *         &lt;element name="returnval" type="{urn:vim25}DistributedVirtualSwitchHostProductSpec" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class QueryDvsCompatibleHostSpecResponse {
    ...
    public List<DistributedVirtualSwitchHostProductSpec> getReturnval() {
        if (returnval == null) {
            returnval = new ArrayList<DistributedVirtualSwitchHostProductSpec>();
        }
