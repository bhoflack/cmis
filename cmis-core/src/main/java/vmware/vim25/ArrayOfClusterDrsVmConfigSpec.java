...
/**
 * <p>Java class for ArrayOfClusterDrsVmConfigSpec complex type.
 * 
...
public class ArrayOfClusterDrsVmConfigSpec {
     ...
     * This is why there is not a <CODE>set</CODE> method for the clusterDrsVmConfigSpec property.
     * 
     * <p>
    ...
    public List<ClusterDrsVmConfigSpec> getClusterDrsVmConfigSpec() {
        if (clusterDrsVmConfigSpec == null) {
            clusterDrsVmConfigSpec = new ArrayList<ClusterDrsVmConfigSpec>();
        }
