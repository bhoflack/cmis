...
/**
 * <p>Java class for ArrayOfDistributedVirtualPortgroupInfo complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="DistributedVirtualPortgroupInfo" type="{urn:vim25}DistributedVirtualPortgroupInfo" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfDistributedVirtualPortgroupInfo {
     ...
     * This is why there is not a <CODE>set</CODE> method for the distributedVirtualPortgroupInfo property.
     * 
     * <p>
    ...
    public List<DistributedVirtualPortgroupInfo> getDistributedVirtualPortgroupInfo() {
        if (distributedVirtualPortgroupInfo == null) {
            distributedVirtualPortgroupInfo = new ArrayList<DistributedVirtualPortgroupInfo>();
        }
