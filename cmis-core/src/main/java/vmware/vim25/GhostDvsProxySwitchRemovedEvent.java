...
/**
 * <p>Java class for GhostDvsProxySwitchRemovedEvent complex type.
 * 
...
@XmlType(name = "GhostDvsProxySwitchRemovedEvent", propOrder = {
    "switchUuid"
})
public class GhostDvsProxySwitchRemovedEvent
    extends HostEvent
{
