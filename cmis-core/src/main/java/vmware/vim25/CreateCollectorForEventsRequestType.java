...
/**
 * <p>Java class for CreateCollectorForEventsRequestType complex type.
 * 
...
@XmlType(name = "CreateCollectorForEventsRequestType", propOrder = {
    "_this",
    "filter"
})
public class CreateCollectorForEventsRequestType {
