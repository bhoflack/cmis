...
/**
 * <p>Java class for ArrayOfHostNatServiceConfig complex type.
 * 
...
public class ArrayOfHostNatServiceConfig {
     ...
     * This is why there is not a <CODE>set</CODE> method for the hostNatServiceConfig property.
     * 
     * <p>
    ...
    public List<HostNatServiceConfig> getHostNatServiceConfig() {
        if (hostNatServiceConfig == null) {
            hostNatServiceConfig = new ArrayList<HostNatServiceConfig>();
        }
