...
/**
 * <p>Java class for ArrayOfLocalizableMessage complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="LocalizableMessage" type="{urn:vim25}LocalizableMessage" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ArrayOfLocalizableMessage", propOrder = {
    "localizableMessage"
})
public class ArrayOfLocalizableMessage {
     ...
     * This is why there is not a <CODE>set</CODE> method for the localizableMessage property.
     * 
     * <p>
    ...
    public List<LocalizableMessage> getLocalizableMessage() {
        if (localizableMessage == null) {
            localizableMessage = new ArrayList<LocalizableMessage>();
        }
