...
/**
 * <p>Java class for HostServiceInfo complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="service" type="{urn:vim25}HostService" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends DynamicData
{
    ...
    public List<HostService> getService() {
        if (service == null) {
            service = new ArrayList<HostService>();
        }
        return this.service;
    }
