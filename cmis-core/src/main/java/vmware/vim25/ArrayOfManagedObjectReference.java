...
/**
 * <p>Java class for ArrayOfManagedObjectReference complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="ManagedObjectReference" type="{urn:vim25}ManagedObjectReference" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfManagedObjectReference {
     ...
     * This is why there is not a <CODE>set</CODE> method for the managedObjectReference property.
     * 
     * <p>
    ...
    public List<ManagedObjectReference> getManagedObjectReference() {
        if (managedObjectReference == null) {
            managedObjectReference = new ArrayList<ManagedObjectReference>();
        }
