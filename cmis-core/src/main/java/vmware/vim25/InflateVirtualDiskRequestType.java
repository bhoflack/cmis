...
/**
 * <p>Java class for InflateVirtualDiskRequestType complex type.
 * 
...
@XmlType(name = "InflateVirtualDiskRequestType", propOrder = {
    "_this",
    "name",
    "datacenter"
})
public class InflateVirtualDiskRequestType {
