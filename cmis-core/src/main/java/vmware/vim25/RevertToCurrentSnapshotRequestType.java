...
/**
 * <p>Java class for RevertToCurrentSnapshotRequestType complex type.
 * 
...
@XmlType(name = "RevertToCurrentSnapshotRequestType", propOrder = {
    "_this",
    "host",
    "suppressPowerOn"
})
public class RevertToCurrentSnapshotRequestType {
