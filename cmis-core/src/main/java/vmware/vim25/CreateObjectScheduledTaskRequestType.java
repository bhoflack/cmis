...
/**
 * <p>Java class for CreateObjectScheduledTaskRequestType complex type.
 * 
 ...
 *         &lt;element name="spec" type="{urn:vim25}ScheduledTaskSpec"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "CreateObjectScheduledTaskRequestType", propOrder = {
    "_this",
    "obj",
    "spec"
})
public class CreateObjectScheduledTaskRequestType {
     ...
     *     
     */
    public void setSpec(ScheduledTaskSpec value) {
        this.spec = value;
    }
