...
/**
 * <p>Java class for RecommendHostsForVmRequestType complex type.
 * 
...
@XmlType(name = "RecommendHostsForVmRequestType", propOrder = {
    "_this",
    "vm",
    "pool"
})
public class RecommendHostsForVmRequestType {
