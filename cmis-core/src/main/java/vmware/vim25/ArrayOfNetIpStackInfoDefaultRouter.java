...
/**
 * <p>Java class for ArrayOfNetIpStackInfoDefaultRouter complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="NetIpStackInfoDefaultRouter" type="{urn:vim25}NetIpStackInfoDefaultRouter" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfNetIpStackInfoDefaultRouter {
     ...
     * This is why there is not a <CODE>set</CODE> method for the netIpStackInfoDefaultRouter property.
     * 
     * <p>
    ...
    public List<NetIpStackInfoDefaultRouter> getNetIpStackInfoDefaultRouter() {
        if (netIpStackInfoDefaultRouter == null) {
            netIpStackInfoDefaultRouter = new ArrayList<NetIpStackInfoDefaultRouter>();
        }
