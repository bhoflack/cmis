...
/**
 * <p>Java class for ArrayOfScsiLunDescriptor complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="ScsiLunDescriptor" type="{urn:vim25}ScsiLunDescriptor" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfScsiLunDescriptor {
     ...
     * This is why there is not a <CODE>set</CODE> method for the scsiLunDescriptor property.
     * 
     * <p>
    ...
    public List<ScsiLunDescriptor> getScsiLunDescriptor() {
        if (scsiLunDescriptor == null) {
            scsiLunDescriptor = new ArrayList<ScsiLunDescriptor>();
        }
