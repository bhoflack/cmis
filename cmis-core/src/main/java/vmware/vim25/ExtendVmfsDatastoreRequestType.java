...
/**
 * <p>Java class for ExtendVmfsDatastoreRequestType complex type.
 * 
 ...
 *         &lt;element name="spec" type="{urn:vim25}VmfsDatastoreExtendSpec"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ExtendVmfsDatastoreRequestType", propOrder = {
    "_this",
    "datastore",
    "spec"
})
public class ExtendVmfsDatastoreRequestType {
     ...
     *     
     */
    public void setSpec(VmfsDatastoreExtendSpec value) {
        this.spec = value;
    }
