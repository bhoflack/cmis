 ...
 *       &lt;sequence>
 *         &lt;element name="returnval" type="{urn:vim25}HostPathSelectionPolicyOption" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class QueryPathSelectionPolicyOptionsResponse {
    ...
    public List<HostPathSelectionPolicyOption> getReturnval() {
        if (returnval == null) {
            returnval = new ArrayList<HostPathSelectionPolicyOption>();
        }
