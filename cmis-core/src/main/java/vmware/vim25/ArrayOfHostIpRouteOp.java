...
/**
 * <p>Java class for ArrayOfHostIpRouteOp complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="HostIpRouteOp" type="{urn:vim25}HostIpRouteOp" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfHostIpRouteOp {
     ...
     * This is why there is not a <CODE>set</CODE> method for the hostIpRouteOp property.
     * 
     * <p>
    ...
    public List<HostIpRouteOp> getHostIpRouteOp() {
        if (hostIpRouteOp == null) {
            hostIpRouteOp = new ArrayList<HostIpRouteOp>();
        }
