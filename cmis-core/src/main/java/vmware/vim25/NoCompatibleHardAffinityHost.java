...
/**
 * <p>Java class for NoCompatibleHardAffinityHost complex type.
 * 
...
@XmlType(name = "NoCompatibleHardAffinityHost", propOrder = {
    "vmName"
})
public class NoCompatibleHardAffinityHost
