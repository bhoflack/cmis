...
/**
 * <p>Java class for ArrayOfHostConnectInfoNetworkInfo complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="HostConnectInfoNetworkInfo" type="{urn:vim25}HostConnectInfoNetworkInfo" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfHostConnectInfoNetworkInfo {
     ...
     * This is why there is not a <CODE>set</CODE> method for the hostConnectInfoNetworkInfo property.
     * 
     * <p>
    ...
    public List<HostConnectInfoNetworkInfo> getHostConnectInfoNetworkInfo() {
        if (hostConnectInfoNetworkInfo == null) {
            hostConnectInfoNetworkInfo = new ArrayList<HostConnectInfoNetworkInfo>();
        }
