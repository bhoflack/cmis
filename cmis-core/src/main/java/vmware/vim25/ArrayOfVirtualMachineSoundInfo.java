...
/**
 * <p>Java class for ArrayOfVirtualMachineSoundInfo complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="VirtualMachineSoundInfo" type="{urn:vim25}VirtualMachineSoundInfo" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfVirtualMachineSoundInfo {
     ...
     * This is why there is not a <CODE>set</CODE> method for the virtualMachineSoundInfo property.
     * 
     * <p>
    ...
    public List<VirtualMachineSoundInfo> getVirtualMachineSoundInfo() {
        if (virtualMachineSoundInfo == null) {
            virtualMachineSoundInfo = new ArrayList<VirtualMachineSoundInfo>();
        }
