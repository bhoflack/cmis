...
/**
 * <p>Java class for ArrayOfVirtualNicManagerNetConfig complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="VirtualNicManagerNetConfig" type="{urn:vim25}VirtualNicManagerNetConfig" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfVirtualNicManagerNetConfig {
     ...
     * This is why there is not a <CODE>set</CODE> method for the virtualNicManagerNetConfig property.
     * 
     * <p>
    ...
    public List<VirtualNicManagerNetConfig> getVirtualNicManagerNetConfig() {
        if (virtualNicManagerNetConfig == null) {
            virtualNicManagerNetConfig = new ArrayList<VirtualNicManagerNetConfig>();
        }
