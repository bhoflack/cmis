...
/**
 * <p>Java class for ArrayOfHostHostBusAdapter complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="HostHostBusAdapter" type="{urn:vim25}HostHostBusAdapter" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfHostHostBusAdapter {
     ...
     * This is why there is not a <CODE>set</CODE> method for the hostHostBusAdapter property.
     * 
     * <p>
    ...
    public List<HostHostBusAdapter> getHostHostBusAdapter() {
        if (hostHostBusAdapter == null) {
            hostHostBusAdapter = new ArrayList<HostHostBusAdapter>();
        }
