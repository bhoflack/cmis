...
/**
 * <p>Java class for QueryDvsFeatureCapabilityRequestType complex type.
 * 
...
@XmlType(name = "QueryDvsFeatureCapabilityRequestType", propOrder = {
    "_this",
    "switchProductSpec"
})
public class QueryDvsFeatureCapabilityRequestType {
